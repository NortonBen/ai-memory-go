...
// BaselineResult is an alias for BaselineTestResult for compatibility
type BaselineResult = BaselineTestResult

// BaselinePerformanceRequirement holds performance baseline targets
type BaselinePerformanceRequirement struct {
	Name              string
