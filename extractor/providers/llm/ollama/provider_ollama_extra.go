...
func (op *OllamaProvider) GenerateCompletionWithOptions(ctx context.Context, prompt string, options *extractor.CompletionOptions) (string, error) {
	return op.GenerateCompletion(ctx, prompt)
}

// GenerateStructuredOutputWithOptions generates JSON with options
func (op *OllamaProvider) GenerateStructuredOutputWithOptions(ctx context.Context, prompt string, schemaStruct interface{}, options *extractor.CompletionOptions) (interface{}, error) {
...
func (op *OllamaProvider) GenerateWithContext(ctx context.Context, messages []extractor.Message, options *extractor.CompletionOptions) (string, error) {
	return "", fmt.Errorf("not implemented")
}

// GenerateStreamingCompletion generates streaming text
func (op *OllamaProvider) GenerateStreamingCompletion(ctx context.Context, prompt string, callback extractor.StreamCallback) error {
	return fmt.Errorf("not implemented")
}

// GetProviderType returns provider type
func (op *OllamaProvider) GetProviderType() extractor.ProviderType {
	return extractor.ProviderOllama
}

// GetCapabilities returns provider capabilities
func (op *OllamaProvider) GetCapabilities() extractor.ProviderCapabilities {
	caps := extractor.GetProviderCapabilitiesMap()[extractor.ProviderOllama]
	if caps == nil {
...
func (op *OllamaProvider) GetUsage(ctx context.Context) (*extractor.UsageStats, error) {
	return &extractor.UsageStats{}, nil
}

// GetRateLimit returns rate limit info
func (op *OllamaProvider) GetRateLimit(ctx context.Context) (*extractor.RateLimitStatus, error) {
	return &extractor.RateLimitStatus{}, nil
}

// Configure changes provider configuration
func (op *OllamaProvider) Configure(config *extractor.ProviderConfig) error {
	if config != nil {
		if config.Endpoint != "" {
...
func (op *OllamaProvider) GetConfiguration() *extractor.ProviderConfig {
	return &extractor.ProviderConfig{
		Type:     extractor.ProviderOllama,
		Model:    op.model,
