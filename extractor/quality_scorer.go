// Package extractor - Quality scoring and validation for entity and relationship extraction
package extractor
...
func NewBasicQualityScorer(provider LLMProvider, config *QualityScoringConfig) *BasicQualityScorer {
	if config == nil {
