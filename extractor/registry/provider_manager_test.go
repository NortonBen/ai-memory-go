...
func TestDefaultProviderManager(t *testing.T) {
	...
	t.Run("AddProvider", func(t *testing.T) {
		provider := ext.NewMockLLMProvider(ext.ProviderOpenAI, "gpt-4")
	...
	t.Run("GetProvider", func(t *testing.T) {
		provider := ext.NewMockLLMProvider(ext.ProviderOllama, "llama2")
	...
	t.Run("ListProviders", func(t *testing.T) {
		provider1 := ext.NewMockLLMProvider(ext.ProviderOpenAI, "gpt-4")
		provider2 := ext.NewMockLLMProvider(ext.ProviderOllama, "llama2")
...
func TestDefaultEmbeddingProviderManager(t *testing.T) {
	...
	t.Run("AddProvider", func(t *testing.T) {
		provider := ext.NewMockEmbeddingProvider("text-embedding-3-small", 1536)
	...
	t.Run("GetProvider", func(t *testing.T) {
		provider := ext.NewMockEmbeddingProvider("nomic-embed-text", 768)
	...
	t.Run("GenerateEmbeddingWithFailover", func(t *testing.T) {
		...
		provider1 := ext.NewMockEmbeddingProvider("text-embedding-3-small", 1536)
		provider2 := ext.NewMockEmbeddingProvider("nomic-embed-text", 768)
