...
func NewSQLiteVectorStore(path string, dimension int) (*SQLiteVectorStore, error) {
	if dimension <= 0 {
		dimension = 768
	}
...
func (s *SQLiteVectorStore) StoreBatchEmbeddings(ctx context.Context, embeddings []*EmbeddingData) error {
...
func (s *SQLiteVectorStore) SimilaritySearch(ctx context.Context, queryEmbedding []float32, limit int, threshold float64) ([]*SimilarityResult, error) {
	return s.SimilaritySearchWithFilter(ctx, queryEmbedding, nil, limit, threshold)
}

func (s *SQLiteVectorStore) SimilaritySearchWithFilter(ctx context.Context, queryEmbedding []float32, filters map[string]interface{}, limit int, threshold float64) ([]*SimilarityResult, error) {
	if limit <= 0 {
		limit = 10
	}
...
func (s *SQLiteVectorStore) CreateCollection(_ context.Context, _ string, _ int, _ *CollectionConfig) error {
	return nil
}
...
func (s *SQLiteVectorStore) GetCollectionInfo(ctx context.Context, name string) (*CollectionInfo, error) {
	var count int64
